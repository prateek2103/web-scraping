...
for start in range(0,1):
    try:
        ...
        url= "https://in.linkedin.com/jobs/search?keywords=engineer&location=Delhi"
        ...
        with open("x.html","r") as f:
            with open("data.csv","a") as f2:
                ...
                jobs=soup.findAll(class_=["result-card","job-result-card","result-card--with-hover-state"])
                for job in jobs:
